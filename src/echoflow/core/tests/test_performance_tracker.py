...
from echoflow.core.performance_tracker import PerformanceTracker, collect_system_metrics
...
@patch("echoflow.core.performance_tracker.psutil.cpu_count", return_value=8)
@patch(
    "echoflow.core.performance_tracker.psutil.virtual_memory",
