"""Structured logging adapter and application logging configuration."""
...
class StructlogAdapter(ILogger):
    """Adapt structlog's bound logger to Scholion's narrow logging protocol."""
...
def configure_logging(
    ...
    app_logger = logging.getLogger("scholion")
...
def reset_logging() -> None:
    """Reset Scholion logging state for an isolated application/test lifecycle."""
    app_logger = logging.getLogger("scholion")
    app_logger.handlers.clear()
