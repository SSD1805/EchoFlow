...
from scholion.desktop import research_serialization, research_validation
...
from scholion.desktop.research_anchor_bridge import dispatch_research_anchor
from scholion.desktop.research_search_bridge import dispatch_research_search
from scholion.library.errors import ResearchStateError
from scholion.library.locations import (
    LibraryLocationKind,
...
def handle_request(payload: object, services: DesktopServices) -> dict[str, object]:
    ...
    try:
        ...
        return failure_response(
            request_id,
            code="internal_error",
            message="Scholion could not complete the local desktop request",
        )
