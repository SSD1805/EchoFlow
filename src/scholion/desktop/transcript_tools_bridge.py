...
from scholion.library.speaker_presentation import SpeakerPresentationSpan
from scholion.library.transcript_tools import TranscriptDetails, TranscriptToolsService
...
def handle_request(
    ...
    try:
        ...
        return failure_response(
            request_id,
            code="internal_error",
            message="Scholion could not complete that transcript-tools request",
        )
