...
from scholion.library.errors import ResearchStateError, TranscriptProjectionError
from scholion.library.evidence import (
    EvidenceAnchor,
    EvidenceContextSegment,
    EvidenceLocation,
)
from scholion.library.index import IndexedDocument, IndexedSegment, IndexedTranscript
from scholion.library.research_anchor_review import (
    ResearchAnchorReviewService,
    ResearchAnchorStatus,
)
from scholion.library.research_state import ResearchAnchorStateStore, ResearchNote
...
def test_candidate_rejects_changed_projection_identity(
    ...
    monkeypatch.setattr(
        "scholion.library.research_anchor_review.load_indexed_transcript",
