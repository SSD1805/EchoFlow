...
from scholion.library.errors import SpeakerLabelStateError, TranscriptToolingError
from scholion.library.index import IndexedDocument, TranscriptIndex
from scholion.library.speaker_label_service import (
    SpeakerLabelService,
    SpeakerRosterEntry,
)
...
from scholion.transcription.export import (
...
class TranscriptToolsService:
    ...
    def _reserve_publication(self, directory: Path, filename: str) -> Path:
        ...
        for index in range(1, _MAX_COLLISION_ATTEMPTS + 1):
            ...
            return candidate
        raise TranscriptToolingError(
            "Scholion could not allocate a unique transcript export filename"
        )
