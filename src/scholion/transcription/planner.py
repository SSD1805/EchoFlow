...
from scholion.runner.models import ExecutionPolicy, ProcessingProfile
from scholion.runner.policy import RunnerPolicyPlanner
from scholion.runner.topology import HardwareTopology, HardwareTopologyInspector
from scholion.transcription.capabilities import (
    EngineCapabilities,
    EngineCapabilityRegistry,
)
from scholion.transcription.checkpoint import ResumeSettings
from scholion.transcription.enhancement import ffmpeg_afftdn_configuration
from scholion.transcription.enhancement_models import EnhancementConfiguration
...
from scholion.transcription.strategy import (
    StrategyAssessment,
    StrategyCatalog,
    StrategyDefinition,
    StrategyEvaluator,
...
from scholion.workspace.models import ArtifactKind, Job, JobId
    ...
    def _managed_model_revision(self, model_id: str) -> str:
        ...
        if revision is None:
            raise ModelUnavailableError(
                ...
                f"`scholion models install {model_id}` first"
            )
        return revision
