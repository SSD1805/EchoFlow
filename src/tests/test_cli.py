...
def test_unexpected_internal_failure_uses_reserved_internal_exit_code():
    with patch("src.cli.AppContainer", side_effect=RuntimeError("private detail")):
