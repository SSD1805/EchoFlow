...
from src.core.errors import StorageError, StorageNotFoundError
from src.interfaces.base_file_manager import FileManager
...
def test_atomic_replace_failure_cleans_temp_and_preserves_destination(
    ...
    with (
        patch(
            "src.interfaces.local_file_manager.os.replace",
